<div class="mx-auto max-w-5xl space-y-5">
    ...
    <article class="rounded-panel border border-slate-200 bg-white p-5 shadow-panel sm:p-8">
        <div class="flex flex-wrap gap-2 text-xs font-black uppercase tracking-wide text-slate-500"><span>{{ $articleStatusLabel }}</span><span>{{ $localeLabel }}</span><span>{{ $articleTypeLabel }}</span></div>
