    ...
    <div class="mt-2 flex flex-col gap-2 sm:flex-row">
        <div class="relative min-w-0 flex-1">
            ...
            <input
                ...
                class="min-h-12 w-full rounded-control border border-slate-300 bg-white py-3 pl-11 pr-4 text-base text-slate-800 outline-none transition placeholder:text-slate-600 focus:border-emerald-600 focus:ring-4 focus:ring-emerald-100"
                data-help-search-input
            >
            <div id="help-suggestions-{{ $attributes->get('id', 'main') }}" role="listbox" aria-label="{{ __('help.accessibility.search_combobox') }}" class="absolute inset-x-0 top-full z-40 mt-2 hidden max-h-80 overflow-y-auto rounded-control border border-slate-200 bg-white p-2 shadow-elevated" data-help-search-list></div>
        </div>
