    ...
    <div class="mx-auto max-w-[1760px] px-3 sm:px-6 lg:px-8">
        <div class="grid gap-8 py-8 md:grid-cols-2 md:py-10 xl:grid-cols-[minmax(0,1.5fr)_minmax(0,0.75fr)_minmax(0,0.75fr)] xl:gap-12">
            ...
            <nav aria-labelledby="footer-catalog-navigation" class="min-w-0">
                <h2 id="footer-catalog-navigation" class="text-sm font-bold text-slate-800">Навигация</h2>
                <ul class="mt-3 space-y-1">
                    <li>
                        <a href="{{ route('home') }}" @class([
                            ...
                            <i class="fa-solid fa-house w-4 text-center text-slate-400" aria-hidden="true"></i>
                            <span>Главная</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('titles.index') }}" @class([
                            ...
                            <i class="fa-solid fa-table-cells-large w-4 text-center text-slate-400" aria-hidden="true"></i>
                            <span>Каталог</span>
                        </a>
                    </li>
                    @auth
                        <li>
                            <a href="{{ route('viewing-activity') }}" @class([
                                ...
                                <i class="fa-solid fa-clock-rotate-left w-4 text-center text-slate-400" aria-hidden="true"></i>
            ...
            <nav aria-labelledby="footer-service-navigation" class="min-w-0">
                <h2 id="footer-service-navigation" class="text-sm font-bold text-slate-800">Служебные страницы</h2>
                <ul class="mt-3 space-y-1">
                    <li>
                        <a href="{{ route('stats') }}" @class([
                            ...
                            <i class="fa-solid fa-chart-simple w-4 text-center text-slate-400" aria-hidden="true"></i>
                    ...
                    <li>
                        <a href="{{ route('sitemap') }}" class="-mx-3 flex min-h-11 items-center gap-3 rounded-control px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-emerald-700">
                            <i class="fa-solid fa-sitemap w-4 text-center text-slate-400" aria-hidden="true"></i>
                    ...
                    <li>
                        <a href="{{ route('feed') }}" class="-mx-3 flex min-h-11 items-center gap-3 rounded-control px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-50 hover:text-emerald-700">
                            <i class="fa-solid fa-rss w-4 text-center text-slate-400" aria-hidden="true"></i>
                            <span>RSS-лента</span>
                        </a>
                    </li>
                </ul>
