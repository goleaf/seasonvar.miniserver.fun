...
<header data-site-header {{ $attributes->class(['border-b border-slate-200 bg-white shadow-panel lg:sticky lg:top-0 lg:z-50']) }}>
    <div @class([
        'mx-auto grid max-w-[1760px] grid-cols-[minmax(0,1fr)_auto] items-center gap-3 px-3 py-3 sm:px-6 lg:px-8',
        'lg:grid-cols-[minmax(0,1fr)_auto]' => request()->routeIs('titles.index', 'titles.year', 'titles.taxonomy'),
        'lg:grid-cols-[auto_minmax(280px,1fr)_auto]' => ! request()->routeIs('titles.index', 'titles.year', 'titles.taxonomy'),
    ])>
        ...
        @unless (request()->routeIs('titles.index', 'titles.year', 'titles.taxonomy'))
