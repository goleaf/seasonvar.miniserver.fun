...
>
    <span class="min-w-0 flex-1">
        <span class="block break-words text-lg font-semibold leading-6 text-slate-900 group-hover:text-emerald-800">
            {{ $item->name }}
        </span>
        <span class="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-sm font-semibold text-slate-600">
    ...
    <x-ui.icon name="fa-solid fa-arrow-right shrink-0 text-xs text-slate-400 transition group-hover:translate-x-0.5 group-hover:text-emerald-800" />
</a>
