...
Команда защищена от параллельного запуска, постепенно проверяет старые видео-ссылки без статуса доступности и отключает некорректные склеенные ссылки источника.
