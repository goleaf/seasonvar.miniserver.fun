...
Команда защищена от параллельного запуска, постепенно проверяет старые видео-ссылки без статуса доступности, дополняет старые медиа качеством/форматом, нормализует статусы уже разобранных страниц и отключает некорректные склеенные ссылки источника.
