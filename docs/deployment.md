...
1. Deploy rolling-safe code, then run additive migration `2026_07_16_120000_add_canonical_recommendation_discovery.php`. Verify new relation table, five user-state fields/versions and four focused activity/feedback/status indexes; do not rebuild or wipe existing similarity/user data.
