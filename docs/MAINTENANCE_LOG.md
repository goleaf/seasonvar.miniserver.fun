...
- Подтверждено безопасное состояние Laravel 13: приложение работает на Laravel 13.19/PHP 8.5, зависимости соответствуют официальному upgrade guide, выполнено targeted Composer-обновление совместимого набора и обновлена документация upgrade-процесса.
...
- Последнее автоматическое обновление блоков документации: 09.07.2026.
