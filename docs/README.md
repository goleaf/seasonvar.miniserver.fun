...
| Рекомендации и discovery | [`superpowers/specs/2026-07-13-recommendation-v3-list-design.md`](superpowers/specs/2026-07-13-recommendation-v3-list-design.md) | Канонические types/sources/context, public/personal ranking, similarity/relations, exclusions, diversity, random, privacy/cache/SEO и verified limitations. Живой аудит и acceptance — в [`superpowers/plans/2026-07-13-recommendation-v3-list.md`](superpowers/plans/2026-07-13-recommendation-v3-list.md). |
...
| Локализация интерфейса и главной страницы | [`architecture.md`](architecture.md), [`frontend.md`](frontend.md) | Поддерживаемые locale, selection/fallback, PHP-каталоги, DB content translations, locale routes/Livewire, switcher, даты/числа, SEO и a11y. Cache dimension и invalidation остаются во владельце [`caching.md`](caching.md), translator/admin workflow — в [`administration.md`](administration.md) и [`development.md`](development.md). |
