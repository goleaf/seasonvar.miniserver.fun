...
В текущей Codex-сессии доступны Laravel Boost, GitHub app connector, Sites, Codex Document Control и Adobe connector. Google Workspace/Search Console/Analytics MCP в сессии не авторизованы, поэтому для них подготовлены инструкции и шаблоны, но не активная проектная конфигурация.
