...
| Playwright MCP | Пример добавлен | User/global config или trusted project после проверки браузера | Только для UI QA; на сервере сначала проверить Chrome/Chromium |
