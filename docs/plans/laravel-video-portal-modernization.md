...
- [x] Disposable service exercise found a freshly…33935 tokens truncated…/Sanctum architecture remains; routes, guard, broker, signed verification, CSRF and noindex/sitemap boundaries are unchanged and inspectable.
