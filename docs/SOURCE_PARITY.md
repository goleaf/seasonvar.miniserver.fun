...
| `static` | 16 | нет | да | да | да | — | `home` |
| `rss` | 1 | нет | да | да | нет | — | `feed` |
| `sitemap` | 5 | нет | да | да | нет | — | `sitemap.index` |

- Нет parser support: static, rss, sitemap.
- Нет локальной публичной страницы: нет.
