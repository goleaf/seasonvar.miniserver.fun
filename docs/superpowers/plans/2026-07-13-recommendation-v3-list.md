...
- [x] Update owner documentation and English changelog, inspect the isolated patch, commit only Task 18 files on `main`, push and verify the remote SHA without absorbing concurrent work. Design commit `648227337842af7777e4a81fbac630850084c4ca` and product commit `269599f6fbeb2b0783ce188a012192c5201433cf` are ancestors of the verified `origin/main` state.
...
- [x] Update owner documentation and English changelog, inspect the isolated patch, commit only Task 18 files on `main`, push and verify the remote SHA without absorbing concurrent work. Product commit `3afc06aed77746e57c7a8fddbb1b664361bdc79e` matched `origin/main` immediately after push; mixed Task 20 documentation hunks and every unrelated worktree change were excluded.
