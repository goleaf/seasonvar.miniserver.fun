...
- [x] Update owner documentation and English changelog, inspect exact staged scope, commit only this follow-up on `main`, push fast-forward and verify implementation commit `2c0d58202f7891b4d6bd542c28ee7c8da130c5b7` on `origin/main` while preserving unrelated in-progress work and leaving active import state untouched.
