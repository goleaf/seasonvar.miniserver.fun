...
- [ ] **Step 1: Add failing DTO/confidence tests**
...
- [ ] **Step 3: Implement readonly DTOs and enums**
...
- [ ] **Step 4: Add exact personalized_v2 config**
...
- [ ] **Step 3: Implement recency and diminishing evidence**
...
- [ ] **Step 4: Compute progress depth in grouped queries**
...
- [ ] **Step 5: Preserve negative-source removal and private labels**
...
- [ ] **Step 6: Verify GREEN and query budget**
...
- [ ] **Step 2: Add failing multi-source support tests**
...
- [ ] **Step 4: Store/resolve active range**
...
- [ ] **Step 5: Implement candidate contributions**
...
- [ ] **Step 1: Add failing cold/low/medium/high tests**
...
- [ ] **Step 3: Replace private `signals()` implementation**
...
- [ ] **Step 4: Blend without duplicates**
...
- [ ] **Step 5: Verify GREEN and legacy routes**
...
- [ ] **Step 1: Add failing threshold/decay tests**
...
- [ ] **Step 3: Aggregate only allowlisted content features**
...
- [ ] **Step 3: Implement slot and seed rules**
...
- [ ] **Step 4: Integrate after exact exclusions/visibility, before diversity**
...
- [ ] **Step 5: Verify GREEN and translation**
...
- [ ] **Step 1: Add failing rollout/cache/privacy tests**
...
- [ ] **Step 4: Preserve hard cache boundary**
...
- [ ] **Step 5: Verify GREEN and security diff**
