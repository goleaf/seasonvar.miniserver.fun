...
- [ ] **Step 3: Remove the standalone Blade panel**
...
- [ ] **Step 4: Remove only data that became unused with the panel**
...
- [ ] **Step 5: Remove the orphaned translations**
...
- [ ] **Step 6: Confirm the removed presentation contract has no remaining references**
...
- [ ] **Step 7: Format PHP and run the focused visual-system test class**
...
- [ ] **Step 1: Add the permanent UI rule**
...
- [ ] **Step 2: Verify the documentation states both the prohibition and preservation boundary**
...
- [ ] **Step 5: Commit the documentation rule**
