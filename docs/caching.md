...
- до claim проверяет общий `SeasonvarImportActivity`; active import оставляет intent pending и получает один delayed unique tail вместо тяжёлого stats/home/self-HTTP прохода;
