...
- Готовый FTS driver также оставляет candidate IDs внутри параметризованного SQL-подзапроса, общего для выдачи, total и фасетов; application не загружает полный набор совпавших ID в PHP.
