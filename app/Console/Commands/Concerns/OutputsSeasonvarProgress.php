...
trait OutputsSeasonvarProgress
{
    ...
    private static function eventLabels(): array
    {
        return [
            ...
            'seasonvar-media-size-backlog-time-budget-exhausted' => 'Допроверка размеров достигла лимита времени',
    ...
    private static function contextLabels(): array
    {
        return [
            ...
            'elapsed_milliseconds' => 'прошло_миллисекунд',
            ...
            'time_budget_exhausted' => 'лимит_времени_исчерпан',
            'time_budget_seconds' => 'лимит_времени_секунд',
            'title' => 'название',
            'titles' => 'карточек',
            'total' => 'всего',
