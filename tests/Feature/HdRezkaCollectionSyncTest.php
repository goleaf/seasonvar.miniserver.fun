...
final class HdRezkaCollectionSyncTest extends TestCase
{
    ...
    public function test_full_two_page_sync_reconciles_all_items_cover_signals_and_warm_request(): void
    {
        Queue::fake();
        $titles = [
        ...
        $this->assertEqualsCanonicalizing(array_column($titles, 'id'), $warmWork->titleIds);
        $this->assertTrue($warmWork->refresh);
